                                    ...
                                    <div className="kblog">
                                        ...
                                        <div className="kblog-text kblog-text2 kblog-text22">
                                            <div className="kblog-meta pb-10">
                                                <Link href="/blog-details"><a><i className="fal fa-user-circle"></i> {article.user}</a></Link>
                                                <Link href="/blog-details"><a><i className="fal fa-comments"></i> {article.comments}</a></Link>
                                            </div>
