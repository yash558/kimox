                        ...
                        <div className="col-xxl-4 col-xl-4 col-lg-4">
                            <div className="sidebar-wrap">
                                <div className="widget_categories grey-bg">
                                    ...
                                    <ul>
                                        <li><Link href="/service-details"><a>Web Developement <i className="far fa-long-arrow-right"></i></a></Link></li>
                                        <li><Link href="/service-details"><a>Graphic Design <i className="far fa-long-arrow-right"></i></a></Link></li>
                                        <li><Link href="/service-details"><a>SEO & Content Writting <i className="far fa-long-arrow-right"></i></a></Link></li>
                                        <li><Link href="/service-details"><a>Digital Marketing <i className="far fa-long-arrow-right"></i></a></Link></li>
                                        <li><Link href="/service-details"><a>App Development <i className="far fa-long-arrow-right"></i></a></Link></li>
                                    </ul>
                                </div>
